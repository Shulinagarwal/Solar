    ...
    <div className='relative flex flex-col lg:flex-row w-full overflow-hidden'>
            <div className='flex flex-col  mt-28 gap-10 w-full lg:w-1/2'>
                ...
                <div className='ml-0 flex '>
                     <img src="/p9.png" alt="" className=' relative h-40 sm:h-48 md:h-64 lg:h-80 '/>
                    ...
                    {/* <div className='w-[40%] flex justify-start items-center'>
                     <h1 className='relative font-orbitron font-medium text-sm'>Phobos</h1>
            ...
            <div className='flex flex-col gap-5'>
                   ...
                   <div className=' p-6 pl-6  rounded-[8%] border-4 flex border-[#370D44] bg-ct flex-row gap-9 items-center justify-center w-[70%] lg:w-[85%]'>
                    ...
                    <div className=''>
                        ...
                        <p className='font-extrabold text-xl lg:text-4xl font-orbitron'>20 Celcius</p>
                    </div>
                   </div>
                   <div className=' p-6 pl-6  rounded-[8%] border-4 flex border-[#370D44] bg-ct flex-row gap-9 items-center justify-center w-[70%] lg:w-[85%]'>
                    ...
                    <div className=''>
                        ...
                        <p className='font-extrabold text-xl lg:text-4xl font-orbitron'>-73 Celcius</p>
                    </div>
                   </div>
                </div>
            </div>
